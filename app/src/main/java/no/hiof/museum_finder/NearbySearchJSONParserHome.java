...
public class NearbySearchJSONParserHome {
    ...
    private HashMap<String, String> parseMuseumJSONObject(JSONObject jsonObject) {
        ...
        try {
            ...
            /**
             *These checks if the api request has the value we are looking for, and if not we set a default value.
             * These are needed beacuse we still thinks its valuable to show the museum object even if its
             * not complete with information.
             */
